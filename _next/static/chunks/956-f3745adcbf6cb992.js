    ...
    5956: function (e, t, n) {
      ...
      function T(e) {
        ...
        let h = (0, a.Z)(
            ...
            "Toastify__progress-bar--".concat(r),
            { "Toastify__progress-bar--rtl": f }
          ),
          E = i(c)
            ? c({ rtl: f, type: r, defaultClassName: h })
            : (0, a.Z)(h, c);
      ...
      (N.loading = (e, t) =>
        ...
        (N.promise = function (e, t, n) {
          ...
          a &&
            (o = r(a) ? N.loading(a, n) : N.loading(a.render, { ...n, ...a }));
          let c = {
              isLoading: null,
              autoClose: null,
              closeOnClick: null,
            ...
            d = (e, t, a) => {
              ...
              let s = { type: e, ...c, ...n, data: a },
                i = r(t) ? { render: t } : t;
              return (
                o ? N.update(o, { ...s, ...i }) : N(i.render, { ...s, ...i }), a
              );
            },
            u = i(e) ? e() : e;
          return (
            u.then((e) => d("success", l, e)).catch((e) => d("error", s, e)), u
          );
        }),
        (N.success = L("success")),
        (N.info = L("info")),
        ...
        (N.warning = L("warning")),
        (N.warn = N.warning),
        (N.dark = (e, t) => I(e, C("default", { theme: "dark", ...t }))),
          ...
          let {
              ...
              function h(t) {
                ...
                c.canDrag &&
                  ...
                  (n.style.transform = "translate3d(".concat(
                    "x" === e.draggableDirection
              ...
              null ==
                (n = p.get(
                  (t = { id: e.toastId, containerId: e.containerId, fn: s })
                    .containerId || 1
                )) || n.setToggle(t.id, t.fn),
                (0, o.useEffect)(() => {
              ...
              return (
                d &&
                  u &&
                  ((T.onMouseEnter = v), e.stacked || (T.onMouseLeave = y)),
                g &&
                  (T.onClick = (e) => {
            ...
            S = (0, a.Z)(
              ...
              "Toastify__toast--".concat(m),
              { "Toastify__toast--rtl": A },
              { "Toastify__toast--close-on-click": D }
            ),
            z = i(E)
              ? E({ rtl: A, position: h, type: m, defaultClassName: S })
              : (0, a.Z)(S, E),
            H = (function (e) {
      ...
      function O(e) {
              ...
              (function (e) {
                ...
                return {
                  subscribe(n) {
                      ...
                      let a = 1,
                        ...
                        T = (e) => {
                          ...
                          e.staleId && y.delete(e.staleId),
                            ...
                            l && i(a) && a((0, o.isValidElement)(r) && r.props);
                        };
                      return {
                        id: e,
                        props: g,
                        ...
                        buildToast: (t, f) => {
                          ...
                          let w = {
                            ...
                            bodyClassName: l(
                              f.bodyClassName || g.bodyClassName
                            ),
                            progressClassName: l(
                            ...
                            deleteToast() {
                              ...
                              i(t) && t((0, o.isValidElement)(a) && a.props),
                                n(u(e, "removed")),
                                y.delete(b),
                                --d < 0 && (d = 0),
                          ...
                          let P = t;
                          (0, o.isValidElement)(t) && !r(t.type)
                            ? (P = (0, o.cloneElement)(t, {
                                closeToast: N,
                                toastProps: w,
                                data: I,
                              }))
                          ...
                          let A = { content: P, props: w, staleId: C };
                          g.limit && g.limit > 0 && d > g.limit && k
                            ? p.push(A)
                            : s(L)
                            ? setTimeout(() => {
                                T(A);
                    ...
                    let d = a.observe(n);
                    return (
                      f.forEach((e) => h(e.content, e.options)),
                      (f = []),
                      () => {
                        d(), p.delete(t);
                      }
        ...
        return (
          ...
          o.createElement(
            ...
            E((e, t) => {
              let s = t.length ? { ...I } : { ...I, pointerEvents: "none" };
              return o.createElement(
                "div",
                {
                  className: (function (e) {
                    ...
                    return i(_)
                      ? _({ position: e, rtl: C, defaultClassName: t })
                      : (0, a.Z)(t, l(_));
                  })(e),
                  style: s,
